...
import { MapPin, Brain, Eye, CircleAlert as AlertCircle, CircleCheck as CheckCircle2, Compass } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0B0F2A] via-[#1a1f3a] to-[#0B0F2A]">
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="xl:text-center lg:text-center md:text-center sm:text-center mb-16">
          ...
          <h1 className="text-5xl font-serif font-bold text-[#F5F3EE] mb-6">
          ...
          <p className="text-base text-[#AAB0D6]/80 max-w-2xl mx-auto mt-4">
