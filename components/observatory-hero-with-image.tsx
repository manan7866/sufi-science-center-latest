...
interface ObservatoryHeroWithImageProps {
  title: string;
  title2?: string;
  subtitle?: string;
...
export function ObservatoryHeroWithImage({
  title,
  title2,
  subtitle,
  description,
  ...
  return (
    <section className="relative w-full min-h-[600px] overflow-hidden observatory-gradient">
      ...
      <div className="relative z-10 h-full flex flex-col lg:flex-row items-center justify-center  px-6 py-20 lg:py-0 gap-10 lg:gap-16 max-w-7xl mx-auto">
        ...
        <div className="flex-1 flex flex-col lg:items-start items-center justify-center  text-center lg:text-left">
          {subtitle && (
            <p className="text-[#C8A75E] text-sm font-mono uppercase text-left tracking-[0.2em] mb-4 animate-in fade-in duration-700">
              {subtitle}
            </p>
          )}

          <h1 className="text-4xl text-center sm:text-left md:text-6xl lg:text-7xl font-serif font-bold text-[#F5F3EE] mb-6 leading-[1.1] tracking-tight animate-in fade-in duration-700 delay-100">
            {title}
          </h1>
          ...
          {subDescription && (
            <p className="text-lg md:text-xl mb-4 text-[#AAB0D6] max-w-3xl leading-relaxed animate-in fade-in duration-700 delay-200">
              {subDescription}
            </p>
          )}
